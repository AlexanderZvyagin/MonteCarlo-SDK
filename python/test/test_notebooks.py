...
@testbook (f'{notebooks_directory}/t04_ItoIsometry.ipynb', execute=True)
def test (tb):
    pass
...
@testbook (f'{notebooks_directory}/t06_SABR.ipynb', execute=True)
def test (tb):
    pass

@testbook (f'{notebooks_directory}/t07_HullWhiteModel.ipynb', execute=True)
def test (tb):
    pass

@testbook (f'{notebooks_directory}/t08_SumAtPoints.ipynb', execute=True)
def test (tb):
    pass
