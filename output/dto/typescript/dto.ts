...
UpdaterDoc_equal (a: UpdaterDoc, b: UpdaterDoc) : boolean {
    ...
    if(!string_equal(a.log_level,b.log_level)) return false;
...
UpdaterDto_equal (a: UpdaterDto, b: UpdaterDto) : boolean {
    ...
    if(a.logging===undefined && b.logging!==undefined) return false;
    if(a.logging!==undefined && b.logging===undefined) return false;
    if(a.logging!==undefined && b.logging!==undefined)
    if(!string_equal(a.logging!,b.logging!)) return false;
    return true;
}
...
UpdaterDto_from_json(j:object, obj:UpdaterDto) {
    ...
    if("start" in j)
        ...
        obj.start = undefined;
    if("logging" in j)
        obj.logging = j["logging"] as string|undefined;
    else
        obj.logging = undefined;
}
...
class Model {
    ...
    constructor(
        ...
        LogSize : number|undefined  = undefined,
        nstates : number  = 0,
    ){
...
Model_equal (a: Model, b: Model) : boolean {
    ...
    if(a.LogLevel===undefined && b.LogLevel!==undefined) return false;
    if(a.LogLevel!==undefined && b.LogLevel===undefined) return false;
    if(a.LogLevel!==undefined && b.LogLevel!==undefined)
    if(!string_equal(a.LogLevel!,b.LogLevel!)) return false;
    if(a.LogSize===undefined && b.LogSize!==undefined) return false;
    if(a.LogSize!==undefined && b.LogSize===undefined) return false;
    if(a.LogSize!==undefined && b.LogSize!==undefined)
    if(!int_equal(a.LogSize!,b.LogSize!)) return false;
    return true;
}
...
Model_fromJSON (j:any, obj: Model): void {
    ...
    if("LogLevel" in j)
        obj.LogLevel = j["LogLevel"];
    if("LogSize" in j)
        obj.LogSize = j["LogSize"];
}
export function
...
Model_from_json(j:object, obj:Model) {
    ...
    if("LogLevel" in j)
        obj.LogLevel = j["LogLevel"] as string|undefined;
    else
        obj.LogLevel = undefined;
    if("LogSize" in j)
        obj.LogSize = j["LogSize"] as number|undefined;
    else
        obj.LogSize = undefined;
}
...
Model_to_json(j:object, obj:Model) {
    ...
    if( obj.LogLevel !== undefined) {
        j["LogLevel"] = obj.LogLevel;
    }
    if( obj.LogSize !== undefined) {
        j["LogSize"] = obj.LogSize;
    }
}
...
class EvaluationResults {
    ...
    version : string = "EvaluationResults:1";
    names : string[];
    npaths : number[];
    mean : number[];
    stddev : number[];
...
EvaluationResults_equal (a: EvaluationResults, b: EvaluationResults) : boolean {
    ...
    if(!list_equal(a.histograms,b.histograms,Histogram_equal)) return false;
    if(!list_equal(a.logs,b.logs,string_equal)) return false;
