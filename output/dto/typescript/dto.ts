...
// 
// Generated from schema: MonteCarlo SDK version (0.3.0)
// 
...
class CashFlows extends Updater {
...
export function
CashFlows_equal (a: CashFlows, b: CashFlows) : boolean {
    if(!Updater_equal(a,b)) return false;
    return true;
}

export function
CashFlows_fromJSON (j:any, obj: CashFlows): void {
    Updater_fromJSON(j,obj)
}
export function
CashFlows_fromJSON_string (jstr:string): CashFlows {
    const j = JSON.parse(jstr);
    const obj = new CashFlows();
    CashFlows_fromJSON(j,obj);
    return obj;
}
export function
CashFlows_from_json_string (jstr:string): CashFlows {
    const j: object = JSON.parse(jstr);
    const obj: CashFlows = new CashFlows();
    CashFlows_from_json(j,obj);
    return obj;
}

export function
CashFlows_to_json_string (self:CashFlows) {
    const j = {};
    CashFlows_to_json(j,self);
    return JSON.stringify(j);
}

export function
CashFlows_from_json(j:object, obj:CashFlows) {
    Updater_from_json(j,obj);
}

export function
CashFlows_to_json(j:object, obj:CashFlows) {
    Updater_to_json(j,obj);
}
