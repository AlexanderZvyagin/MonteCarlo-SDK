...
// Generated by CODE GENERATOR OF DATA TRANSFER OBJECTS (cgdto) version 0.3.1
// 
//         Generated from: MonteCarlo SDK version (0.1.1)
//         
...
class DtoError {
    ...
    errors : DtoError[]|undefined;

    constructor(
        message : string|undefined  = undefined,
        details : string|undefined  = undefined,
        code : number|undefined  = undefined,
        errors : DtoError[]|undefined  = undefined,
    ){
...
export function
DtoError_equal (a: DtoError, b: DtoError) : boolean {
    ...
    if(a.errors!==undefined && b.errors!==undefined)
        if(!list_equal(a.errors!,b.errors!,DtoError_equal)) return false;
    return true;
}

export function
DtoError_fromJSON (j:any, obj: DtoError): void {
    if("message" in j)
...
export function
DtoError_fromJSON_string (jstr:string): DtoError {
    const j = JSON.parse(jstr);
    const obj = new DtoError();
    DtoError_fromJSON(j,obj);
    return obj;
}
export function
DtoError_to_json(j:object, obj:DtoError) {
...
export function
DtoError_from_json(j:object, obj:DtoError) {
    if("message" in j)
    ...
    if("code" in j)
        ...
        obj.code = undefined;
    if( "errors" in j)
        obj.errors = j["errors"] as DtoError[]|undefined;
}

export function
DtoError_to_json_string (self:DtoError) {
    const j = {};
    DtoError_to_json(j,self);
    return JSON.stringify(j);
}

export function
DtoError_from_json_string (jstr:string): DtoError {
    const j: object = JSON.parse(jstr);
    const obj: DtoError = new DtoError();
    DtoError_from_json(j,obj);
    return obj;
}
