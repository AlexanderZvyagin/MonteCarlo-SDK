...
class UpdaterDoc:
    ...
    def __eq__ (self, other):
        ...
        if self.log_level != other.log_level: return False
...
'''
    ...
    def __eq__ (self, other):
        ...
        if self.start != other.start: return False
        if self.logging != other.logging: return False
        return True
    def __neq__ (self, other):
        return not self==other
    def json (self) -> str:
...
def UpdaterDto_from_json (j:dict, obj:UpdaterDto):
    ...
    if j.get("start",None) is not None:
        obj.start = j["start"]
    if j.get("logging",None) is not None:
...
class Model:
    ...
    def __init__ (
        ...
        LogSize:int|None = None,
        nstates:int = 0
    ):
        self.version : str = "Model:2"
    ...
    def __eq__ (self, other):
        ...
        if self.LogSize != other.LogSize: return False
        return True
    def __neq__ (self, other):
        return not self==other
    def json (self) -> str:
...
def Model_from_json (j:dict, obj:Model):
    ...
    if j.get("LogLevel",None) is not None:
        obj.LogLevel = j["LogLevel"]
    if j.get("LogSize",None) is not None:
...
def Model_to_json(j:dict, obj:Model):
    ...
    if obj.LogLevel is not None:
        j["LogLevel"] = obj.LogLevel
    if obj.LogSize is not None:
...
class EvaluationResults:
    ...
    def __init__ (
        ...
        self.version : str = "EvaluationResults:1"
