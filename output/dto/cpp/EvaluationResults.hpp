...
// Generated by CODE GENERATOR OF DATA TRANSFER OBJECTS (cgdto) version 0.8.1
// 
...
public:
    ...
    std::vector<Histogram2> histograms2;
    ...
    bool operator == (const EvaluationResults &other) const {
        ...
        if (histograms2 != other.histograms2) return false;
...
void from_json(const json &j, EvaluationResults &obj) try {
    ...
    j.at("histograms2").get_to(obj.histograms2);
